    ...
    if (!identical(unique_surveys_missing, character(0))) {
      ...
      so_som_afscdb_to_add <- so_som_afscdb_avg %>%
        ...
        select(
          ...
          organic_layer_weight_orig, coarse_fragment_vol_orig,
          part_size_clay_orig, part_size_silt_orig,
          part_size_sand_orig,
          bulk_density_source, organic_carbon_total_source,
          organic_layer_weight_source, coarse_fragment_vol_source,
