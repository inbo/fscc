...
# Calculate reactive Al stocks until 100 cm (or until the effective soil depth
# if shallower)
# ---------------------------------------------------------------------------
...
if (calculate_new_stocks == TRUE) {
  ...
  for (survey_form_i in c("s1", "so")) {
    ...
    data <- read.csv(paste0(dir,
                            survey_form_i,
                            "_profile_rea_al_stocks.csv"),
                     sep = ";")

    assign_env(paste0(survey_form_i, "_profile_rea_al_stocks"),
               data)
    ...
    data <- read.csv(paste0(dir,
                            survey_form_i,
                            "_plot_rea_al_stocks.csv"),
                     sep = ";")

    assign_env(paste0(survey_form_i, "_plot_rea_al_stocks"),
               data)
...
graph_interval(data = plot_rea_al_stocks %>%
...
data_so_full <- plot_rea_al_stocks %>%
